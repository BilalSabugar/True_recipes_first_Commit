...
Then add the tomatoes. Saute till the tomatoes become soft and add chilli powder and salt. Saute for 2-3 minutes and then grind it into a fine paste.
</Text>
...
<TouchableOpacity style={{flexDirection:'row',marginBottom:20}} onPress={()=>{this.props.navigation.navigate('Butter_Paneer_Step_3')}}>
