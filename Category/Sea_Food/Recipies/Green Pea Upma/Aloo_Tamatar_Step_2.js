...
export default class Aloo_Tamatar_Step_2 extends React.Component {
...
In another bowl marinate the paneer cubes with turmeric, salt, chilli powder and some oil. Flash fry them. Keep aside.In another bowl marinate the paneer cubes with turmeric, salt, chilli powder and some oil. Flash fry them. Keep aside.
</Text>
...
<TouchableOpacity style={{flexDirection:'row',marginBottom:20}} onPress={()=>{this.props.navigation.navigate('Aloo_Tamatar_Step_3')}}>
