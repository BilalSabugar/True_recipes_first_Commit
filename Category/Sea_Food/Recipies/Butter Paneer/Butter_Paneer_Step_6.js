...
export default class Aloo_Tamatar_Step_6 extends React.Component {
...
<TouchableOpacity style={{flexDirection:'row',marginBottom:20}} onPress={()=>{this.props.navigation.navigate('Butter_Paneer_Step_7')}}>
