...
export default class Sea_Food extends React.Component {
    ...
    render() {
      return (
        ...
        <View  style={{backgroundColor:'#656255',justifyContent:'center',height:Dimensions.get("screen").height}}>


<View style={{borderBottomWidth:0.5,borderBottomColor:'#ffffff',marginBottom:8,elevation:1.3}}>

<TouchableOpacity onPress={()=>{this.props.navigation.goBack()}}>
  <Image style={{alignSelf:'flex-start',height:25,width:35,marginLeft:15,marginTop:15,marginBottom:8}} source={require('../../../assets/All-Icons/back_arrow_white.png')}></Image>
</TouchableOpacity>
...
{/* ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  ////////////////////////////////////////////////////////////////////////////////*/}
          ...
          <ScrollView style={{height:'100%',backgroundColor:'#656255'}}>
...
<Card style={{backgroundColor:'#656255'}}>
...
<Card style={{backgroundColor:'#656255',marginTop:15}}>
...
<Card style={{backgroundColor:'#656255',marginTop:15,marginBottom:15,alignItems:'center'}}>
...
<Card style={{backgroundColor:'#656255',marginTop:15,marginBottom:50,alignItems:'center'}}>
