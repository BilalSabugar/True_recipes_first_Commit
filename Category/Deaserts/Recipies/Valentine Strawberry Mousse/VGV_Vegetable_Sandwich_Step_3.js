...
<Text style={{justifyContent:'flex-start',fontSize:23,color:'#ffffff',fontWeight:'bold',marginLeft:15,marginTop:20}}>For the gravy:</Text>
...
<TouchableOpacity style={{flexDirection:'row',marginBottom:20}} onPress={()=>{this.props.navigation.navigate('Aloo_Tamatar_Step_4')}}>
