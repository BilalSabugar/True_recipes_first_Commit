...
export default class Aloo_Tamatar_Step_5 extends React.Component {
...
TAdd salt, hing, red chilli powder and turmeric powder. Saute them well.
</Text>
...
<TouchableOpacity style={{flexDirection:'row',marginBottom:20}} onPress={()=>{this.props.navigation.navigate('Tamarind_Rice_Step_6')}}>
